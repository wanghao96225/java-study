...
//     *
//     * @param key 要删除的key
//     * @return 删除是否成功 - 返回删除成功的数量
//     */
//    public long kDelete(String key) {
//        log.info("kDelete(...) => key -> {}", key);
//        // 返回值只可能为true/false, 不可能为null
//        long result = redissonConfig.initBean().getKeys().delete(key);
//        log.info("kDelete(...) => result -> {}", result);
//        if (result == 0) {
//            throw new RedissonUtil.RedisOpsResultIsNullException();
//        }
//        return result;
//    }
//
